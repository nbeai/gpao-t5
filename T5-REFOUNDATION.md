# T5 First Completion — History & Evidence Reference

상태: `FIRST_COMPLETE_REFERENCE`
현재 개발 정본: `T5-SECOND-COMPLETION.md`

이 문서는 T5 1차 완성까지의 개발 역사·실패 원본·Gate 증거를 보존하는 참조다. 현재 Gate와 작업 범위는
`T5-SECOND-COMPLETION.md`, 제품 정의는 `T5-PRODUCT.md`, 작업 규율은 `AGENTS.md`가 담당한다.
후발 개발 세션은 현재 계획에 필요한 과거 근거를 찾을 때만 이 문서를 읽는다.
