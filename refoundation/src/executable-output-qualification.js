...
function makeRuntimeExecutableQualifier() {
...
export function qualifyGeneratedExecutableOutput({ archiveBytes, contract } = {}) {
  return makeRuntimeExecutableQualifier()({ archiveBytes, contract });
}

export function makeExecutableOutputQualifier() {
  const qualify = makeRuntimeExecutableQualifier();
