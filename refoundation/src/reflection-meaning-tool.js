...
export function makeReflectionMeaningTool({ coordinator, runtimeSnapshot } = {}) {
  ...
  const parameters = {
    ...
    properties: {
      ...
      unknowns: { type: 'array', uniqueItems: true, maxItems: 32,
