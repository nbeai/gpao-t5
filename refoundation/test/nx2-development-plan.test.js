...
test('NX-2 plan records NX-1 closeout, the current Context Diet slice, and excludes generic GUI work', async () => {
  ...
  assert.match(plan, /NX2_4_AU1_SOURCE_COMPLETE/);
  assert.match(plan, /NX2_4_AU2_COMPLETE/);
  assert.match(plan, /NX2_4_AU3_COMPLETE/);
  assert.match(plan, /NX2_4_AU4_CURRENT/);
