...
test('재창립 정본은 제품·진행·작업 규율로 분리된다', () => {
  ...
  assert.match(map, /현재 Gate: `R6-W5 BROWSER FILE TRANSFER — COMPLETE`/);
  assert.match(map, /계획된 Web Hand의 마지막 한 작업은\s+`R6-W6 Authenticated Business Workflow Qualification`/);
