...
test('정본은 제품·현재 계획·1차 역사·작업 규율로 분리된다', () => {
  ...
  assert.match(plan, /현재 Gate: `CP COMPLETE · QH-1 COMPLETE · QH-2 OBSERVATION CORE COMPLETE · QH-3 CORE COMPLETE WITH MODEL OBSERVATION · QH-4 PROVIDER QUALIFIED ABSENT`/);
  ...
  assert.match(plan, /상태: `SECOND_COMPLETION_INTEGRATED_SOURCE_SEALED_WITH_RELEASE_BLOCKERS`/);
