...
test('정본은 제품·현재 계획·1차 역사·작업 규율로 분리된다', () => {
  ...
  assert.match(plan, /현재 Gate: `CP COMPLETE · P0 COMPLETE · QH-1 COMPLETE · QH-2 CORE ACCEPTED · QH-3 KNOWN OBSERVATION ACCEPTED · QH-4 PROVIDER DEFERRED`/);
  ...
  assert.match(plan, /상태: `SECOND_COMPLETION_SOURCE_COMPLETE_PACKAGE_READY`/);
