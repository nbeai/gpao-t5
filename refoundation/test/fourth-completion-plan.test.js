...
test('4차 정본은 generic snapshot shell 자격 뒤 adapter integration만 연다', async () => {
  ...
  assert.match(plan, /현재 Gate: `S4-G MODEL-INDEPENDENT ACTIVATION · GENERIC SNAPSHOT SHELL ADAPTER INTEGRATION NEXT`/u);
