...
test('4차 정본은 G batch handoff contract를 닫고 Snapshot integration만 연다', async () => {
  ...
  assert.match(plan, /현재 Gate: `S4-G OUTPUT HANDOFF · SNAPSHOT ADAPTER INTEGRATION NEXT`/u);
