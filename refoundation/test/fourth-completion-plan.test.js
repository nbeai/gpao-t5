...
test('4차 정본은 G Snapshot handoff를 닫고 model-independent Console integration만 연다', async () => {
  ...
  assert.match(plan, /현재 Gate: `S4-G PRODUCT ACTIVATION · MODEL-INDEPENDENT EXEC INTEGRATION NEXT`/u);
