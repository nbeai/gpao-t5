...
test('4차 정본은 actual command-shape 분산 뒤 generic snapshot shell만 연다', async () => {
  ...
  assert.match(plan, /현재 Gate: `S4-G MODEL-INDEPENDENT ACTIVATION · GENERIC SNAPSHOT SHELL BACKEND DESIGN`/u);
