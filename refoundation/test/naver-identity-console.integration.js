    ...
    modelFactory: () => ({ async respond(input) {
      ...
      if (turn === 2) { assert.ok(input.tools.some((tool) => tool.name === 'naver'));
        return { text: '', toolCalls: [{ id: 'mail-list', name: 'naver', args: {
          ...
          draftHandle: null, blogDraftHandle: null, recipients: null, subject: null, title: null, body: null,
          attachmentIds: null, sourceAttachmentId: null, category: null, tags: null,
