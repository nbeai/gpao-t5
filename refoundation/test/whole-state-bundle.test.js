...
import { createWholeStateBundle, restoreWholeStateBundle,
  stageWholeStateGeneration } from '../src/whole-state-bundle.js';
...
test('wrong password·cipher 변경·relationship 실패는 기존 destination을 한 byte도 바꾸지 않는다', async () => {
  for (const fault of ['password', 'cipher', 'relationship']) {
