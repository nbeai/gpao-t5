...
test('Naver 연구는 하나의 identity에서 Mail protocol과 Blog Browser를 분리한다', async () => {
  ...
  assert.match(plan, /RESEARCH_COMPLETE · OWNER_GATE_OPEN · NV0_COMPLETE · NV1_COMPLETE · NV1R_COMPLETE · NV2_COMPLETE · NV3_CURRENT · PRODUCT_IMPLEMENTATION_GATE_OPEN/u);
