...
const DESCRIPTORS = [
  ...
  defineTool({
    ...
    capability: '보고 있는 화면을 다룬다 — 아래로 내리고, 탭과 더보기를 펴고,'
      + ' 앞선 관찰이 준 자리(ref)를 짚어 그 칸에 글자를 치고 검색 칸에서 엔터를 친다.'
    ...
    limits: [{ 동사: 'click', says: '링크는 누르지 않는다 — 주소를 알면 browser.observe 로 연다' },
    ...
    schema: {
      description: '보고 있는 화면을 다룬다.'
        ...
        + ' `click` 앞선 관찰이 준 ref 의 **탭·더보기만**(링크 대신 주소를 알면 browser.observe 로 연다) ·'
      ...
      parameters: {
        ...
        properties: {
          ...
          ref: { type: 'string', description: '앞선 관찰이 준 ref. click 은 탭·더보기, type·press 는 `canType` 의 칸' },
