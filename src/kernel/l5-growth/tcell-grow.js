...
} from './tcell-verdict.js';

// **기존 공개 경로를 그대로 둔다.** 이 세 이름은 바깥(검사)이 tcell-grow.js 에서 가져다 쓴다 —
// 추출은 자리를 옮긴 것이지 남의 import 를 깨는 일이 아니다.
export { 유효성요청, computeCaseVerdict, verifySuiteFromMemory };
