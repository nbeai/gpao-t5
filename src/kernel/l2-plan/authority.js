...
const LOW_RISK_ALWAYS = Object.freeze(['read', 'isolated_compute', 'summarize', 'search', 'draft']);
...
export const DERIVED_KINDS = Object.freeze([
  'read', 'isolated_compute', 'organize', 'write', 'delete', 'send', 'field_input', 'export_sensitive', 'connect_account',
]);
