...
(정오 2026-08-02, W2: 아래 AC-2 → AC-3 → AC-4 표기는 **작성 순서**이지 실행 순서가 아니다.
오너 승인 미션과 병렬 제안서 §6 에 따라 셋은 **병렬로 구현하고 통합만 이 순서로** 한다.
공통 계약과 shared file 은 W2 서두에 본선이 직렬로 닫는다 — AC1-RECHECK §5·§5-A.)
