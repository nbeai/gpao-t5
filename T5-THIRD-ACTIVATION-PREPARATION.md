...
상태: `THIRD_COMPLETION_0_3_1_PRODUCT_BASELINE · PRODUCT_CLEANROOM_COMPLETE · WINDOWS_CODE_READY_EXTERNAL_QUALIFICATION_PENDING · S3M_ADAPTIVE_DEFERRED · S3CA_DEFERRED_TO_FOURTH`
...
3차 제품 기준: `0.3.1 · source fd58c2da · S3-CA/M6 비활성 · Windows physical qualification 대기`

Product Cleanroom의 pre-clean 기준은 annotated tag `t5-0.3.1-pre-clean-baseline`, 종료 기준은
`t5-0.3.1-clean-baseline`이다. Prompt·제품 의미·UI 디자인·새 기능은 바꾸지 않았고, production·platform·
qualification·4차·historical 책임을 분류한 뒤 caller와 과거 기록 호환성이 모두 없는 가족만 제거했다.
완료 근거는 `refoundation/evidence/product-cleanroom-closeout-2026-08-28.json`이다.
