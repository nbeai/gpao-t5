...
- 현재 차단:
  - ~~인간 시나리오 H01~H10 현재 코어 실측 미실행~~ → **3회 실측 완료**(2026-07-30).
    실제 서버·브라우저·`gpt-5.1`, 오너 조작 0, 제품 코드 변경 0.
    공통 결함 4(H01·H04·H05·H08) · 모델 변동 3(H03·H09·H10) · 통과 3(H02·H06·H07).
    증거: `docs/03-verification/evidence/human-baseline/H-BASELINE-3RUNS-2026-07-30-ko.md`
