...
test('⑥ 사용자가 문장을 **고쳐도** 그 기억은 살아 있다(신분은 표식이 든다)', async () => {
  ...
  // 반환 모양이 바뀌었다(2026-08-05): 표식 있는 줄과 **사람이 손으로 쓴 줄**을 함께 낸다.
  // 예전엔 표식 줄만 봐서 사람이 쓴 기억이 통째로 무시됐다(파일 머리말의 약속과 어긋났다).
  assert.equal(남은것.표식있는것.get('a1'), '내가 고친 문장', '고친 문장을 못 읽었다');
});
